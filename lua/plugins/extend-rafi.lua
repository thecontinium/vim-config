return {
...

  {
    ...
    opts = function(_, opts)
      ...
      opts.defaults.vimgrep_arguments =
        vim.tbl_extend("force", opts.defaults.vimgrep_arguments, has_ripgrep and vimgrep_args or nil)
    end,
  },
  ...
  { "folke/persistence.nvim", enabled = false },
  {
    ...
    init = function()
      vim.keymap.set("n", "<localLeader>s", "<cmd>Telescope neovim-project history<CR>", { desc = "Sessions" })
